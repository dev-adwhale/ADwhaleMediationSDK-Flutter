...
#================== AdWhale SDK Core Proguard for Release 적용 코드 시작 ==================

# AdWhale SDK 핵심 클래스 유지
-keep class net.adwhale.sdk.mediation.** { *; }
-keep class net.adwhale.sdk.** { *; }
-dontwarn net.adwhale.sdk.**

#================== AdWhale SDK Core Proguard for Release 적용 코드 끝 ==================
